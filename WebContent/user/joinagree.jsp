...
<head>
	...
	<link href="${conPath}/css/joinagree.css" rel="stylesheet">
...
1. 이 약관은 0000년 00월 00일부터 적용됩니다.
        ...
        <div class="joinagree_radio">
          
          <input type="radio" name="agree_1" id="agree1_y" value="agree_1_y"><label for="agree1_y" class="custom-radio-container">사이트 이용약관에 동의합니다.</label>&nbsp;
          <input type="radio" name="agree_1" id="agree1_n" value="agree_1_n" checked><label for="agree1_n" class="custom-radio-container">사이트 이용약관에 동의하지 않습니다.</label>
        </div>
      </div>
      <div class="col-area">
  ...
  - 계약 또는 청약철회 등에 관한 기록 : 5년
        ...
        <div class="joinagree_radio">
          <input type="radio" name="agree_2" id="agree2_y" value="agree_2_y"><label for="agree2_y" class="custom-radio-container">개인정보 처리방침에 동의합니다.</label>
          <input type="radio" name="agree_2" id="agree2_n" value="agree_2_n" checked><label for="agree2_n" class="custom-radio-container">개인정보 처리방침에 동의하지 않습니다.</label>
        </div>
      </div>
...
<script>
  $(document).ready(function () {
    $('form').submit(function (event) {
      if ($("input[type=radio][id=agree2_n]:checked").length > 0) {
        alert('개인정보 처리방침에 동의하지 않으면 회원가입할 수 없습니다.');
        event.preventDefault();
      }
      if ($("input[type=radio][id=agree1_n]:checked").length > 0) {
        alert('사이트 이용약관에 동의하지 않으면 회원가입할 수 없습니다.');
        event.preventDefault();
      }
    });
  });
